...
(function(){
	...
	var nude = (function(){
		...
		scanImage = function(){
			...
			var myWorker = new Worker('/assets/js/DenyNaughty/worker.nude.js'),
		...
		return {
			init: function(){
				...
				if(!!!window.Worker){
					document.write(unescape("%3Cscript src='/assets/js/DenyNaughty/noworker.nude.js' type='text/javascript'%3E%3C/script%3E"));
				}
