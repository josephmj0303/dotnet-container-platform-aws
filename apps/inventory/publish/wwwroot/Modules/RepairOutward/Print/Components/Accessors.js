...
RepairOutwardPrint.Components.Setter = function (Param) {
    
    /* Set the Customer Details */
    typeof Param.RSONo !== "undefined" ? $(".lblRSONo").html(Param.RSONo) : $(".lblRSONo").html("");
    typeof Param.RSODate !== "undefined" ? $(".lblRSODate").html(GeneralFunction.DateFormat(Param.RSODate)) : $(".lblRSODate").html("");
    typeof Param.RSINo !== "undefined" ? $(".lblRSINo").html(Param.RSINo) : $(".lblRSINo").html("");
    ...
    if (typeof Param.TaxDetails !== "undefined" && Param.TaxDetails.length > 0) {
        RepairOutwardPrint.Components.TaxSetter(Param.TaxDetails);
    }
    ...
    if (typeof Param.RepairOutwardDetails !== "undefined" && Param.RepairOutwardDetails.length > 0) {
        ...
        for (var i = 0; i < Param.RepairOutwardDetails.length; i++) {
            var item = Param.RepairOutwardDetails[i];
            var tr = $('<tr></tr>');
...
RepairOutwardPrint.Components.Getter = function (Param) {
...
RepairOutwardPrint.Components.TaxSetter = function (Param) {
    $("#tbdTaxDetails").html("");
...
RepairOutwardPrint.Components.OrganizationSetter = function (Param) {
