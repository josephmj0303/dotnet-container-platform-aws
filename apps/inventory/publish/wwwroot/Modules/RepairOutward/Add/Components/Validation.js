/* ==== */
/* Repair Outward Validation Components Objects */
RepairOutward.Components.Validation = {};
/* ==== */

/* ==== */
/* Repair Outward Components Validation */
RepairOutward.Components.Validation.Initialize = function (Params) {
...
/* ==== */
/* Repair Outward Components Validation Status */
RepairOutward.Components.Validation.Status = function (Params) {
                    ...
                    if (typeof Params.Data.ProductDetails !== "undefined") {
                        if (Params.Data.ProductDetails.length >= 0) {
                            for (var i = 0; i < Params.Data.ProductDetails.length; i++) {
                                ...
                                if (t_ProductCode == "" || t_ProductName == "" || t_Weight <= 0) {
                                    t_InValidRows += 1;
