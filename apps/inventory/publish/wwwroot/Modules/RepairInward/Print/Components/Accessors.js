...
RepairInwardPrint.Components.Setter = function (Param) {
    
    /* Set the Customer Details */
    typeof Param.RSINo !== "undefined" ? $(".lblBillNo").html(Param.RSINo) : $(".lblBillNo").html("");
    typeof Param.RSIDate !== "undefined" ? $(".lblBillDate").html(GeneralFunction.DateFormat(Param.RSIDate)) : $(".lblBillDate").html("");
    ...
    if (typeof Param.TaxDetails !== "undefined" && Param.TaxDetails.length > 0) {
        RepairInwardPrint.Components.TaxSetter(Param.TaxDetails);
    }
    ...
    if (typeof Param.RepairInwardDetails !== "undefined" && Param.RepairInwardDetails.length > 0) {
        ...
        for (var i = 0; i < Param.RepairInwardDetails.length; i++) {
            var item = Param.RepairInwardDetails[i];
            var tr = $('<tr></tr>');
...
RepairInwardPrint.Components.Getter = function (Param) {
...
RepairInwardPrint.Components.TaxSetter = function (Param) {
    $("#tbdTaxDetails").html("");
...
RepairInwardPrint.Components.OrganizationSetter = function (Param) {
