...
SalesPrint.Components.Setter = function (Param) {
    
    /* Set the Customer Details */
    typeof Param.BillNo !== "undefined" ? $(".lblBillNo").html(Param.BillNo) : $(".lblBillNo").html("");
    typeof Param.BillDate !== "undefined" ? $(".lblBillDate").html(GeneralFunction.DateFormat(Param.BillDate)) : $(".lblBillDate").html("");
    ...
    if (typeof Param.TaxDetails !== "undefined" && Param.TaxDetails.length > 0) {
        SalesPrint.Components.TaxSetter(Param.TaxDetails);
    }
...
SalesPrint.Components.Getter = function (Param) {
...
SalesPrint.Components.TaxSetter = function (Param) {
    $("#tbdTaxDetails").html("");
...
SalesPrint.Components.OrganizationSetter = function (Param) {
