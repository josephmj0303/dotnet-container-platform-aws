...
Sale.Components.Setter = function (Param) {

    /* Set the Component Values */
    typeof Param.BillNo !== "undefined" ? $("#txtInvNo").val(Param.BillNo) : $("#txtInvNo").val("");
    typeof Param.BillDate !== "undefined" ? $("#txtInvDate").val(GeneralFunction.DateFormat(Param.BillDate)) : $("#txtInvDate").val("");
    ...
    if (typeof Param.SalesDetails !== "undefined" && Param.SalesDetails.length > 0) {
        for (var i = 0; i < Param.SalesDetails.length; i++) {
            /* Add the Product Row */
            Sale.Components.AddNewProduct(Param.SalesDetails[i]);
        }
    }
    ...
    if (typeof Param.TaxDetails !== "undefined" && Param.TaxDetails.length > 0) {
        /* Add the Product Row */
        Sale.Components.TaxSetter(Param.TaxDetails);
    }
}
/* ==== */
...
Sale.Components.Getter = function (Param) {
    ...
    var Response = {
        InvId: $("#hdnInvId").val(),
        BillDate: GeneralFunction.DataClearning($("#txtInvDate").val()),
        CustId: $("#txtSaleCustomerContactNo").attr("data-custId"),
        CustomerName: GeneralFunction.DataClearning($("#txtSaleCustomerName").val()),
...
Sale.Components.ProductSetter = function (Param) {
    if (typeof Param !== "undefined" || Param != null || Param.length != 0) {
        /* Set the Component Values */
        Sale.Components.Products = Param;
    }
}
/* ==== */
...
/* ==== */
/* Sale Components Product Setter */
Sale.Components.TaxSetter = function (Param) {
    $("#tbdTaxDetails").html("");
    if (typeof Param !== "undefined" || Param != null || Param.length != 0) {
            ...
            $("#tbdTaxDetails").append(`
                <tr>
                    ...
                    <td class="text-right bolder black lblTaxPercent" contenteditable="true" 
                       tax-id="${Param[i].TaxId}" tax-percentage="${Param[i].TaxPercentage}" oninput="Sale.Components.CalculateGrandTotal()">0.00</td>
                </tr>
            `);
...
Sale.Components.BillCutomerSetter = function (Param) {

    /* Get the Customer Response */
    typeof Param.CustId !== "undefined" ? $("#txtSaleCustomerContactNo").attr("data-custId", Param.CustId) : $("#txtSaleCustomerContactNo").attr("data-custId", 0);
    typeof Param.CustomerName !== "undefined" ? $("#txtSaleCustomerName").val(Param.CustomerName) : $("#txtSaleCustomerName").val("");
    typeof Param.ContactNo !== "undefined" ? $("#txtSaleCustomerContactNo").val(Param.ContactNo) : $("#txtSaleCustomerContactNo").val("");
}
/* ==== */
...
Sale.Components.CutomerSetter = function (Param) {
...
/* ==== */
/* Sale Customer Components Getter */
Sale.Components.CutomerGetter = function (Param) {
