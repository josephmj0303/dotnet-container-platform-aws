...
PurchaseReturnPrint.Components.Setter = function (Param) {
    
    /* Set the Customer Details */
    typeof Param.GRNRetNo !== "undefined" ? $(".lblBillNo").html(Param.GRNRetNo) : $(".lblBillNo").html("");
    typeof Param.GRNRetDate !== "undefined" ? $(".lblBillDate").html(GeneralFunction.DateFormat(Param.GRNRetDate)) : $(".lblBillDate").html("");
    typeof Param.GRNNo !== "undefined" ? $(".lblGRNNo").html(Param.GRNNo) : $(".lblGRNNo").html("");
    ...
    if (typeof Param.TaxDetails !== "undefined" && Param.TaxDetails.length > 0) {
        PurchaseReturnPrint.Components.TaxSetter(Param.TaxDetails);
    }
    ...
    if (typeof Param.PurchaseReturnDetails !== "undefined" && Param.PurchaseReturnDetails.length > 0) {
        ...
        for (var i = 0; i < Param.PurchaseReturnDetails.length; i++) {
            var item = Param.PurchaseReturnDetails[i];
            var tr = $('<tr></tr>');
...
PurchaseReturnPrint.Components.Getter = function (Param) {
...
PurchaseReturnPrint.Components.TaxSetter = function (Param) {
    $("#tbdTaxDetails").html("");
...
PurchaseReturnPrint.Components.OrganizationSetter = function (Param) {
