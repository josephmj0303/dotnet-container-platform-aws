...
SalesmanOutwardPrint.Components.Setter = function (Param) {
    
    /* Set the Customer Details */
    typeof Param.OutwardNo !== "undefined" ? $(".lblRSONo").html(Param.OutwardNo) : $(".lblRSONo").html("");
    typeof Param.OutwardDate !== "undefined" ? $(".lblRSODate").html(GeneralFunction.DateFormat(Param.OutwardDate)) : $(".lblRSODate").html("");
    ...
    if (typeof Param.TaxDetails !== "undefined" && Param.TaxDetails.length > 0) {
        SalesmanOutwardPrint.Components.TaxSetter(Param.TaxDetails);
    }
...
SalesmanOutwardPrint.Components.Getter = function (Param) {

    /* Get the Sales Print Response */
    var Response = {
        RSOId: GeneralFunction.DataClearning($("#hdnRSOId").val())
    }
    return Response;
}
/* ==== */
...
SalesmanOutwardPrint.Components.TaxSetter = function (Param) {
    $("#tbdTaxDetails").html("");
...
SalesmanOutwardPrint.Components.OrganizationSetter = function (Param) {
