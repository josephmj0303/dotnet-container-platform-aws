...
class DataControllers_SalesmanOutwardPrint {
            ...
            success: function (Response) {
                ...
                if (Response != null) {
                    ...
                    if (Response.status == "Success") {
                        ...
                        SalesmanOutwardPrint.Components.OrganizationSetter(ObjResponse);
                        /* ==== */
            ...
            success: function (Response) {
                ...
                if (Response != null) {
                    ...
                    if (Response.status == "Success") {
                        ...
                        /* ==== */
                        /* Set the Components Values */
                        SalesmanOutwardPrint.Components.Setter(JSON.parse(Response.result));
                        /* ==== */
