/* ==== */
/* Sale Components Setter */
SalesmanOutward.Components.Setter = function (Param) {

    /* Set the Component Values */
    typeof Param.OutwardNo !== "undefined" ? $("#txtInvNo").val(Param.OutwardNo) : $("#txtInvNo").val("");
    typeof Param.OutwardDate !== "undefined" ? $("#txtInvDate").val(GeneralFunction.DateFormat(Param.OutwardDate)) : $("#txtInvDate").val("");
    typeof Param.SalesmanName !== "undefined" ? $("#txtSaleCustomerName").val(Param.SalesmanName) : $("#txtSaleCustomerName").val("");
    typeof Param.ContactNo !== "undefined" ? $("#txtSaleCustomerContactNo").val(Param.ContactNo) : $("#txtSaleCustomerContactNo").val("");
    ...
    if (typeof Param.SalesDetails !== "undefined" && Param.SalesDetails.length > 0) {
        for (var i = 0; i < Param.SalesDetails.length; i++) {
            /* Add the Product Row */
            SalesmanOutward.Components.AddNewProduct(Param.SalesDetails[i]);
        }
    }
    ...
    if (typeof Param.TaxDetails !== "undefined" && Param.TaxDetails.length > 0) {
        /* Add the Product Row */
        SalesmanOutward.Components.TaxSetter(Param.TaxDetails);
    }
}
/* ==== */
...
/* ==== */
/* Sale Components Getter */
SalesmanOutward.Components.Getter = function (Param) {
    ...
    /* Get the Sale Response */
    var Response = {
        SMOUTId: $("#hdnSMOUTId").val(),
        OutwardDate: GeneralFunction.DataClearning($("#txtInvDate").val()),
        SalesmanId: $("#txtSaleCustomerContactNo").attr("data-SalesmanId"),
        SalesmanName: GeneralFunction.DataClearning($("#txtSaleCustomerName").val()),
        ContactNo: GeneralFunction.DataClearning($("#txtSaleCustomerContactNo").val()),
        TotalQty: t_TotalQty,
...
SalesmanOutward.Components.ProductSetter = function (Param) {
    if (typeof Param !== "undefined" || Param != null || Param.length != 0) {
        /* Set the Component Values */
        SalesmanOutward.Components.Products = Param;
    }
}
/* ==== */
...
/* ==== */
/* Sale Components Product Setter */
SalesmanOutward.Components.TaxSetter = function (Param) {
    $("#tbdTaxDetails").html("");
    if (typeof Param !== "undefined" || Param != null || Param.length != 0) {
            ...
            $("#tbdTaxDetails").append(`
                <tr>
                    ...
                    <td class="text-right bolder black lblTaxPercent" contenteditable="true" 
                       tax-id="${Param[i].TaxId}" tax-percentage="${Param[i].TaxPercentage}" oninput="SalesmanOutward.Components.CalculateGrandTotal()">0.00</td>
                </tr>
            `);
...
/* ==== */
/* Sale Customer Components Getter */
SalesmanOutward.Components.BillCutomerSetter = function (Param) {

    /* Get the Customer Response */
    typeof Param.SalesmanId !== "undefined" ? $("#txtSaleCustomerContactNo").attr("data-SalesmanId", Param.SalesmanId) : $("#txtSaleCustomerContactNo").attr("data-SalesmanId", 0);
    typeof Param.CustomerName !== "undefined" ? $("#txtSaleCustomerName").val(Param.CustomerName) : $("#txtSaleCustomerName").val("");
    typeof Param.ContactNo !== "undefined" ? $("#txtSaleCustomerContactNo").val(Param.ContactNo) : $("#txtSaleCustomerContactNo").val("");
}
/* ==== */
...
/* ==== */
/* Sale Customer Components Setter */
SalesmanOutward.Components.CutomerSetter = function (Param) {
...
/* ==== */
/* Sale Customer Components Getter */
SalesmanOutward.Components.CutomerGetter = function (Param) {

    /* Get the Customer Response */
    var Response = {
        SalesmanId: $("#hdnSalesmanId").val(),
