...
/* ==== */
/* Sales Print Components Setter */
SalesReturnPrint.Components.Setter = function (Param) {
    
    /* Set the Customer Details */
    typeof Param.InvRetNo !== "undefined" ? $(".lblSRNNo").html(Param.InvRetNo) : $(".lblSRNNo").html("");
    typeof Param.InvRetDate !== "undefined" ? $(".lblSRNDate").html(GeneralFunction.DateFormat(Param.InvRetDate)) : $(".lblSRNDate").html("");
    typeof Param.BillNo !== "undefined" ? $(".lblBillNo").html(Param.BillNo) : $(".lblBillNo").html("");
    typeof Param.CustomerName !== "undefined" ? $(".lblCustomerName").html(Param.CustomerName) : $(".lblCustomerName").html("");
    ...
    if (typeof Param.TaxDetails !== "undefined" && Param.TaxDetails.length > 0) {
        SalesReturnPrint.Components.TaxSetter(Param.TaxDetails);
    }
    ...
    if (typeof Param.SalesReturnDetails !== "undefined" && Param.SalesReturnDetails.length > 0) {
        ...
        for (var i = 0; i < Param.SalesReturnDetails.length; i++) {
            var item = Param.SalesReturnDetails[i];
            var tr = $('<tr></tr>');
...
/* ==== */
/* Sales Print Components Getter */
SalesReturnPrint.Components.Getter = function (Param) {

    /* Get the Sales Print Response */
    var Response = {
...
SalesReturnPrint.Components.TaxSetter = function (Param) {
    $("#tbdTaxDetails").html("");
        ...
        for (var i = 0; i < Param.length; i++) {
            ...
            $("#tbdTaxDetails").append(`
                <tr>
                    ...
                    <td class="text-right bolder black lblTaxPercent" contenteditable="true">${Param[i].TaxAmount.toFixed(2)}</td>
                </tr>
            `);
        }
    }
...
SalesReturnPrint.Components.OrganizationSetter = function (Param) {
