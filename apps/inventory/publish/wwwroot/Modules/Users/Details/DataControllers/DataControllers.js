...
/* ==== */
/* User Details Data Controllers */
class DataControllers_UserDet {
    ...
    static Pop(Params) {
        ...
        UserDet.Components.DataProcessing(true);

        $.ajax({
            type: "POST",
            url: "/UserAccount/GetUsersDetails",
            data: Params,
            dataType: "text",
            async: true,
            success: function (Response) {
                ...
                UserDet.Components.DataProcessing(false);
