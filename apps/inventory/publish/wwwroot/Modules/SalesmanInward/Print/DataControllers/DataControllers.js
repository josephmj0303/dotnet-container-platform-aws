...
class DataControllers_SalesmanInwardPrint {
            ...
            success: function (Response) {
                ...
                if (Response != null) {
                    ...
                    if (Response.status == "Success") {
                        ...
                        SalesmanInwardPrint.Components.OrganizationSetter(ObjResponse);
                        /* ==== */
            ...
            success: function (Response) {
                ...
                if (Response != null) {
                    ...
                    if (Response.status == "Success") {
                        ...
                        /* ==== */
                        /* Set the Components Values */
                        SalesmanInwardPrint.Components.Setter(JSON.parse(Response.result));
                        /* ==== */
