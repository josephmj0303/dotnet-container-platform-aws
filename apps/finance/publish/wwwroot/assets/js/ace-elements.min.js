...
!(function (a, b) {
    var c = function (b, c) {
        ...
        function e(b) {
            b.preventDefault(),
                b.stopPropagation(),
                (ba = aa = u ? b.pageY : b.pageX),
                (Q = !0),
                a("html").off("mousemove.ace_scroll").on("mousemove.ace_scroll", f),
                a(R).off("mouseup.ace_scroll").on("mouseup.ace_scroll", g),
                A.addClass("active"),
                S && l.$element.trigger("drag.start");
        }
        function f(a) {
        ...
        function i() {
            null != ca && (clearTimeout(ca), (ca = null)),
        ...
        (this.ref = function () {
            ...
            (this.create = function (b) {
                if (!x) {
                    b && (n = a.extend({}, a.fn.ace_scroll.defaults, b)),
                        (this.size = parseInt(this.$element.attr("data-size")) || n.size || 200),
                        (u = !n.horizontal),
                        (o = u ? "top" : "left"),
                        (p = u ? "height" : "width"),
                        (q = u ? "maxHeight" : "maxWidth"),
                        (r = u ? "clientHeight" : "clientWidth"),
                        (s = u ? "scrollTop" : "scrollLeft"),
                        (t = u ? "scrollHeight" : "scrollWidth"),
                        this.$element.addClass("ace-scroll"),
                        "static" == this.$element.css("position") ? ((P = this.element.style.position), (this.element.style.position = "relative")) : (P = !1);
                    var c = null;
                    U
                        ? (c = a('<div class="scroll-track scroll-detached"><div class="scroll-bar"></div></div>').appendTo("body"))
                        : (this.$element.wrapInner('<div class="scroll-content" />'), this.$element.prepend('<div class="scroll-track"><div class="scroll-bar"></div></div>')),
                        (y = this.$element),
                        U || (y = this.$element.find(".scroll-content").eq(0)),
                        u || y.wrapInner("<div />"),
                        (z = y.get(0)),
                        U ? ((A = c), k()) : (A = this.$element.find(".scroll-track").eq(0)),
                        (B = A.find(".scroll-bar").eq(0)),
                        (C = A.get(0)),
                        (D = B.get(0)),
                        (E = D.style),
                        u || A.addClass("scroll-hz"),
                        n.styleClass && ((L = n.styleClass), A.addClass(L), (M = !!L.match(/scroll\-left|scroll\-top/))),
                        0 == N && (A.show(), j()),
                        A.hide(),
                        A.on("mousedown", d),
                        B.on("mousedown", e),
                        ...
                        n.mouseWheel &&
                        ((this.lock = n.mouseWheelLock),
                            (this.lock_anyway = n.lockAnyway),
                            this.$element.on(a.event.special.mousewheel ? "mousewheel.ace_scroll" : "mousewheel.ace_scroll DOMMouseScroll.ace_scroll", function (b) {
                                if (!v) {
                    ...
                    W && A.addClass("idle-hide"),
                        Z &&
                        A.on("mouseenter.ace_scroll", function () {
                            (Y = !0), h(!1);
                        }).on("mouseleave.ace_scroll", function () {
                            (Y = !1), 0 == Q && i();
                        }),
                        this.$element
                            .on("mouseenter.ace_scroll touchstart.ace_scroll", function (a) {
                        ...
                        u || y.children(0).css(p, this.size),
                        y.css(q, this.size),
                        (v = !1),
                        (x = !0);
                }
            ...
            (this.reset = function (a) {
                if (!v) {
                    ...
                    if (!a || _) {
                        ...
                        u || y.children(0).css(p, b),
                            y.css(q, this.size),
                            d > e
                                ? ((w = !0),
                                    A.css(p, e).show(),
                                    (O = parseFloat((e / d).toFixed(5))),
                                    (F = parseInt(Math.round(e * O))),
                                    (I = parseInt(Math.round(F / 2))),
                                    (H = e - F),
                                    (G = parseInt(Math.round(z[s] * O))),
                                    (E[p] = F + "px"),
                                    (E[o] = G + "px"),
                                    A.addClass("scroll-active"),
                                    0 == N && j(),
                                    K || (n.reset && ((z[s] = 0), (E[o] = 0)), (K = !0)),
                                    U && k())
                                : ((w = !1), A.hide(), A.removeClass("scroll-active"), y.css(q, ""));
                    }
                }
            }),
            ...
            (this.destroy = function () {
                (w = !1),
                    ...
                    U || (u || y.find("> div").children().unwrap(), y.children().unwrap(), y.remove()),
                    A.remove(),
                    P !== !1 && (this.element.style.position = P),
                    null != ca && (clearTimeout(ca), (ca = null));
            }),
            ...
            (this.update = function (b) {
                b && (n = a.extend({}, n, b)),
                    ...
                    (this.lock = n.mouseWheelLock || this.lock),
                    (this.lock_anyway = n.lockAnyway || this.lock_anyway),
                    (W = n.hideOnIdle || W),
                    (X = n.hideDelay || X),
                    (Z = n.observeContent || !1),
                    (S = n.dragEvent || !1),
                    "undefined" != typeof b.styleClass && (L && A.removeClass(L), (L = b.styleClass), L && A.addClass(L), (M = !!L.match(/scroll\-left|scroll\-top/)));
            }),
            (this.start = function () {
                z[s] = 0;
            }),
        ...
        var c = function (b, c) {
            ...
            f.addClass("hide")
                ...
                .each(function () {
                    ...
                    b.indexOf("number") >= 0 ||
                        (this.value != b && (this.value = b), this.selected && ((a += " selected"), (h = b)), j.push(b), (g += '<li><a class="' + a + '" style="background-color:' + b + ';" data-color="' + b + '"></a></li>'));
                })
                .end()
                ...
                .after(
                    ...
                    (e.auto_pos ? 'data-position="auto"' : "") +
                    '><span class="btn-colorpicker" style="background-color:' +
                    h +
                    '"></span></a><ul class="dropdown-menu' +
                    (e.caret ? " dropdown-caret" : "") +
                    (e.pull_right ? " dropdown-menu-right" : "") +
                    '">' +
                    g +
                    "</ul></div>"
                );
            ...
            k.on(ace.click_event, function (b, c) {
                ...
                (this.pick = function (c, d) {
                    if ("number" == typeof c) {
                        ...
                        if (
                            ((c = j.indexOf(e)),
                                -1 == c && d === !0 && (j.push(e), a("<option />").appendTo(f).val(e), a('<li><a class="colorpick-btn"></a></li>').appendTo(k).find("a").css("background-color", e).data("color", e), (c = j.length - 1)),
                                -1 == c)
                        )
                            return;
    ...
    (function (a, b) {
        var c = "multiple" in document.createElement("INPUT"),
            ...
            g = function (b, c) {
                ...
                (this.settings = a.extend({}, a.fn.ace_file_input.defaults, c, e)),
                    (this.$element = a(b)),
                    (this.element = b),
                    (this.disabled = !1),
                    (this.can_reset = !0),
                    this.$element.off("change.ace_inner_call").on("change.ace_inner_call", function (a, b) {
        ...
        (g.error = { FILE_LOAD_FAILED: 1, IMAGE_LOAD_FAILED: 2, THUMBNAIL_FAILED: 3 }),
            (g.prototype.apply_settings = function () {
                var b = this;
                (this.multi = this.$element.attr("multiple") && c),
                    (this.well_style = "well" == this.settings.style),
                    this.well_style ? (this.settings.thumbnail || (this.settings.thumbnail = "small"), this.$element.parent().addClass("ace-file-multiple")) : this.$element.parent().removeClass("ace-file-multiple"),
                    ...
                    this.$element.after(
                        ...
                        '">' +
                        (this.settings.no_icon ? '<i class="' + ace.vars.icon + this.settings.no_icon + '"></i>' : "") +
                        "</span></span>"
                    ),
            ...
            (g.prototype.reset_input_ui = function () {
                this.$label
                    .attr({ "data-title": this.settings.btn_choose, class: "ace-file-container" })
                    .find(".ace-file-name:first")
                    .attr({ "data-title": this.settings.no_file, class: "ace-file-name" })
                    .find(ace.vars[".icon"])
                    .attr("class", ace.vars.icon + this.settings.no_icon)
                    .prev("img")
                    .remove(),
            ...
            (g.prototype.loading = function (b) {
                if (b === !1) this.$container.find(".ace-file-overlay").remove(), this.element.removeAttribute("readonly");
                    ...
                    0 == d.length &&
                        ((d = a('<div class="ace-file-overlay"></div>').appendTo(this.$container)),
        ...
        var h = function () {
            ...
            j = function (b) {
                var c = this,
                    ...
                    i = function (b, f) {
                        ...
                        h || (c.settings.previewWidth || c.settings.previewHeight ? (h = { previewWidth: c.settings.previewWidth, previewHeight: c.settings.previewHeight }) : ((h = 50), "large" == c.settings.thumbnail && (h = 150))),
                            "fit" == c.settings.thumbnail ? (h = d.width()) : "number" == typeof h && (h = parseInt(Math.min(h, d.width())));
                        var i = k(b, h);
                        ...
                        if (j) {
                            var m = i.previewWidth,
                                n = i.previewHeight;
                            "small" == c.settings.thumbnail ? (m = n = parseInt(Math.max(m, n))) : d.addClass("large"),
                                a(b)
                                    .css({ "background-image": "url(" + i.src + ")", width: m, height: n })
                                    .data("thumb", i.src)
            ...
            k = function (b, c, d) {
                ...
                "number" == typeof c
                    ? (g = c)
                    : c instanceof Object &&
                    (c.previewWidth && !c.previewHeight ? (i = c.previewWidth) : c.previewHeight && !c.previewWidth ? (h = c.previewHeight) : c.previewWidth && c.previewHeight && ((i = c.previewWidth), (h = c.previewHeight))),
                    g ? (e > f ? ((i = g), (h = parseInt((f / e) * i))) : ((h = g), (i = parseInt((e / f) * h)))) : !h && i ? (h = parseInt((f / e) * i)) : h && !i && (i = parseInt((e / f) * h));
                var j;
                try {
            ...
            l = function (a, b) {
                ...
                return -1 === c
                    ? (this.reset_input(), !1)
                    : c && 0 != c.length
                        ? ((c instanceof Array || (d && c instanceof FileList)) && (a = c),
                            (c = !0),
                            this.settings.before_change && (c = this.settings.before_change.call(this.element, a, b)),
                            -1 === c ? (this.reset_input(), !1) : c && 0 != c.length ? ((c instanceof Array || (d && c instanceof FileList)) && (a = c), a) : (this.$element.data("ace_input_files") || this.reset_input(), !1))
                        : (this.$element.data("ace_input_files") || this.reset_input(), !1);
            },
            m = function (a) {
    ...
    !(function (a) {
        ...
        var b = function (b, c) {
            (this.$element = a(b)),
                (this.options = a.extend({}, a.fn.bs_typeahead.defaults, c)),
                ...
                return (
                    ...
                    !this.query || this.query.length < this.options.minLength
                        ? this.shown
                            ? this.hide()
                            : this
                        : ((c = a.isFunction(this.source) ? this.source(this.query, a.proxy(this.process, this)) : this.source), c ? this.process(c) : this)
                );
            },
            process: function (b) {
                var c = this;
        ...
        (a.fn.bs_typeahead = function (c) {
            ...
            (a.fn.bs_typeahead.defaults = { source: [], items: 8, menu: '<ul class="typeahead dropdown-menu"></ul>', item: '<li><a href="#"></a></li>', minLength: 1 }),
    ...
    (function (a, b) {
        a.fn.ace_wysiwyg = function (b, c) {
            var d = a.extend({ speech_button: !0, wysiwyg: {} }, b),
                ...
                f = {
                    font: { values: ["Arial", "Courier", "Comic Sans MS", "Helvetica", "Open Sans", "Tahoma", "Verdana"], icon: "fa fa-font", title: "Font" },
                    ...
                    createLink: { icon: "fa fa-link", title: "Hyperlink", button_text: "Add", placeholder: "URL", button_class: "btn-primary" },
                    ...
                    insertVideo: {
                        ...
                        title: "Insert video",
                        button_text: '<i class="' + ace.vars.icon + 'fa fa-file"></i> Choose Video &hellip;',
            ...
            return (
                this.each(function () {
                            ...
                            switch (e.name) {
                                case "font":
                                    (b +=
                                        ...
                                        '"></i><i class="' +
                                        ace.vars.icon +
                                        'fa fa-angle-down icon-on-right"></i></a> '),
                                ...
                                case "fontSize":
                                    ...
                                    break;
                                case "createLink":
                                    (b += ' <div class="btn-group"> <a class="btn btn-sm ' + h + ' dropdown-toggle" data-toggle="dropdown" title="' + e.title + '"><i class="' + ace.vars.icon + e.icon + '"></i></a> '),
                                        (b +=
                                            ' <div class="dropdown-menu dropdown-caret dropdown-menu-right">							 <div class="input-group">								<input class="form-control" placeholder="' +
                                            e.placeholder +
                                            '" type="text" data-edit="' +
                                            e.name +
                                ...
                                case "insertImage":
                                    (b += ' <div class="btn-group"> <a class="btn btn-sm ' + h + ' dropdown-toggle" data-toggle="dropdown" title="' + e.title + '"><i class="' + ace.vars.icon + e.icon + '"></i></a> '),
                                        ...
                                        (b +=
                                            '<div class="space-2"></div>							 <label class="center block no-margin-bottom">								<button class="btn btn-sm ' +
                                            e.button_class +
                                ...
                                case "foreColor":
                                case "backColor":
                                    (b += ' <select class="hide wysiwyg_colorpicker" title="' + e.title + '"> '),
                                        a.each(e.values, function (a, c) {
                                            b += ' <option value="' + c + '">' + c + "</option> ";
                                        }),
                                        (b += " </select> "),
                                        (b += ' <input style="display:none;" disabled class="hide" type="text" data-edit="' + e.name + '" /> ');
                                    break;
                                case "viewSource":
                    ...
                    b += " </div> ";
                    var k;
                    d.speech_button && "onwebkitspeechchange" in (k = document.createElement("input")) && (b += ' <input class="wysiwyg-speech-input" type="text" data-edit="inserttext" x-webkit-speech />'),
                        (k = null),
                        (b += " </div> "),
                        (b = d.toolbar_place ? d.toolbar_place.call(this, b) : a(this).before(b).prev()),
                        a.fn.tooltip && b.find("a[title]").tooltip({ animation: !1, container: "body" }),
                        b
                            .find(".dropdown-menu input[type=text]")
                            .on("click", function () {
                                return !1;
                            })
                            .on("change", function () {
                        ...
                        b
                            ...
                            .prev()
                            .on(ace.click_event, function (b) {
                                a(this).next().click();
                            }),
                        b.find(".wysiwyg_colorpicker").each(function () {
                            var b = a(this)
                                .ace_colorpicker({ pull_right: !0 })
                                .change(function () {
                    ...
                    b.find("a[data-view=source]").on("click", function (b) {
                        ...
                        } else a("<textarea />").css({ width: l.outerWidth(), height: l.outerHeight() }).val(l.html()).insertAfter(l), l.hide(), a(this).addClass("active");
                        m = !m;
                    });
                    var n = a.extend(
                        {},
    ...
    (function (a, b) {
        function c(b, c) {
            ...
            e.on_sides
                ? (h
                    .before('<div class="spinbox-buttons input-group-btn">					<button type="button" class="btn spinbox-down ' + i + " " + e.btn_down_class + '">						<i class="icon-only ' + ace.vars.icon + e.icon_down + '"></i>					</button>				</div>')
                    .after('<div class="spinbox-buttons input-group-btn">					<button type="button" class="btn spinbox-up ' + i + " " + e.btn_up_class + '">						<i class="icon-only ' + ace.vars.icon + e.icon_up + '"></i>					</button>				</div>'),
                    k.addClass("touch-spinner"),
                    k.css("width", g + "px"))
                : (h.after(
                    '<div class="spinbox-buttons input-group-btn">					<button type="button" class="btn spinbox-up ' +
                    i +
                    " " +
                    e.btn_up_class +
                    '">						<i class="icon-only ' +
                    ace.vars.icon +
                    e.icon_up +
                    '"></i>					</button>					<button type="button" class="btn spinbox-down ' +
                    i +
                    " " +
                    e.btn_down_class +
                    '">						<i class="icon-only ' +
                    ...
                    ace.vars.touch || e.touch_spinner ? (k.addClass("touch-spinner"), k.css("width", g + "px")) : (h.next().addClass("btn-group-vertical"), k.css("width", g + "px"))),
        ...
        (a.fn.ace_spinner = function (d, e) {
            ...
            (a.fn.ace_spinner.defaults = { icon_up: "fa fa-chevron-up", icon_down: "fa fa-chevron-down", on_sides: !1, btn_up_class: "", btn_down_class: "", max: 999, touch_spinner: !1 });
    })(window.jQuery),
    (function (a, b) {
                ...
                this.each(function () {
                    ...
                    f.addClass("tree").attr("role", "tree"),
                        f.html(
                            ...
                            (e.folderSelect ? '<i class="icon-caret ' + e["folder-open-icon"] + '"></i>&nbsp;' : "") +
                            '				<div class="tree-branch-header">					<span class="tree-branch-name">						<i class="icon-folder ' +
                            e["close-icon"] +
                            '"></i>						<span class="tree-label"></span>					</span>				</div>				<ul class="tree-branch-children" role="group"></ul>				<div class="tree-loader" role="alert">' +
                            e.loadingHTML +
                            '</div>			</li>			<li class="tree-item hide" data-template="treeitem" role="treeitem">				<span class="tree-item-name">				  ' +
                            (null == e["unselected-icon"] ? "" : '<i class="icon-item ' + e["unselected-icon"] + '"></i>') +
                            '				  <span class="tree-label"></span>				</span>			</li>'
                        ),
    ...
    (function (a, b) {
        function c(b, c) {
            ...
            if (
                ((this.settings = a.extend({}, a.fn.ace_aside.defaults, c, j)),
                    !this.settings.background || c.scroll_style || j.scroll_style || (this.settings.scroll_style = "scroll-white no-track"),
            ...
            (this.initiate = function () {
                    ...
                    this.container && (this.container.addClass("overflow-hidden"), ace.vars.firefox && b.offsetHeight),
                        ...
                        f
                            .one("bsTransitionEnd", function () {
                                //f.addClass("aside-hidden"), f.css("position", ""),
                ...
                (this.shown = function () {
                    ...
                    ace.vars.touch
                        ? m.addClass("overflow-scroll").css("max-height", c + "px")
                        : m.hasClass("ace-scroll") ||
                        m.ace_scroll({ size: c, reset: !0, mouseWheelLock: !0, lockAnyway: !this.settings.body_scroll, styleClass: this.settings.scroll_style, observeContent: !0, hideOnIdle: !ace.vars.old_ie, hideDelay: 1500 }),
                        d
        ...
        var d = a(window);
        a(document)
            .on("show.bs.modal", ".modal.aside", function (b) {
            ...
            (a.fn.ace_aside.defaults = { fixed: !1, background: !1, offset: !1, body_scroll: !1, transition: !0, scroll_style: "scroll-dark no-track", container: null, backdrop: !1, placement: "right" });
    })(window.jQuery);
