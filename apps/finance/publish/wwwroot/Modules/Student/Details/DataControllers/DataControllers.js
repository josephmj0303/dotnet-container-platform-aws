...
/* ==== */
/* Student Details Data Controllers */
class DataControllers_StudentDet {
    ...
    static Pop(Params) {
        ...
        StudentDet.Components.DataProcessing(true);
        ...
        $.ajax({
            ...
            success: function (Response) {
                ...
                StudentDet.Components.DataProcessing(false);
