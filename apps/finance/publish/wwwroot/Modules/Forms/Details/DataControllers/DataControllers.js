...
/* ==== */
/* Form Details Data Controllers */
class DataControllers_FormDet {
    ...
    static Pop(Params) {
        ...
        FormDet.Components.DataProcessing(true);

        $.ajax({
            type: "POST",
            url: "/Form/GetFormsDetails",
            data: Params,
            dataType: "text",
            async: true,
            success: function (Response) {
                ...
                FormDet.Components.DataProcessing(false);
