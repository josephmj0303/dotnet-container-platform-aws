...
ApplicationFeesReceipt.Components.Pagination = {}
ApplicationFeesReceipt.Components.Table = {
...
ApplicationFeesReceipt.Components.Pagination.Initialize = function () {
    ...
    ApplicationFeesReceipt.Components.Pagination.TableHead();
...
ApplicationFeesReceipt.Components.Pagination.Cleaner = function () {

    try {

        /* Clear the Pagination Table Components */
        $(ApplicationFeesReceipt.Components.Table.HeadId).html("");
        $(ApplicationFeesReceipt.Components.Table.BodyId).html("");
        $(ApplicationFeesReceipt.Components.Table.FooterId).html("");
...
ApplicationFeesReceipt.Components.Pagination.TableHead = function () {
    ...
    try {
        ...
        t_tr.appendTo(ApplicationFeesReceipt.Components.Table.HeadId);
...
ApplicationFeesReceipt.Components.Pagination.TableBody = function (Result) {
    ...
    try {
        ...
        for (var i = 0; i < Result.length; i++) {
            ...
            t_tr.appendTo(ApplicationFeesReceipt.Components.Table.BodyId);
        }
        /* ==== */

        /* ==== */
        /* Calculate the Footer */
        ApplicationFeesReceipt.Components.Pagination.TableFooter(t_TotalAmount);
        /* ==== */
    }
    catch (ex) {
...
ApplicationFeesReceipt.Components.Pagination.TableFooter = function (TotalAmount) {
    ...
    try {
        ...
        t_tr.appendTo(ApplicationFeesReceipt.Components.Table.FooterId);
...
ApplicationFeesReceipt.Components.Pagination.DeleteRecord = function (RouteId) {
        ...
        buttons: [
            {
                ...
                click: function () {
                    ...
                    ApplicationFeesReceipt.Components.Delete(RouteId);
                    $(this).dialog("close");
                }
            },
            {
