...
FeesReceipt.Components.Validation = {};
/* ==== */

/* ==== */
/* Assign Fees Components Validation */
FeesReceipt.Components.Validation.Initialize = function (Params) {

    /* Home Screen Validation */
     $('#frmFeesReceipt').validate({
        errorElement: 'div',
...
FeesReceipt.Components.Validation.Status = function (Params) {

    var t_Boolean = true;
    if (!$('#frmFeesReceipt').valid()) {
        t_Boolean = false;
    }
    else if ($(FeesReceipt.Components.Table.BodyId + " tr").length == 0) {
