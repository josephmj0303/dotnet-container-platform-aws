...
FeesReceipt.Components.Pagination = {}
FeesReceipt.Components.Table = {
...
FeesReceipt.Components.Pagination.Initialize = function () {
    ...
    FeesReceipt.Components.Pagination.TableHead();
...
FeesReceipt.Components.Pagination.Cleaner = function () {

    try {

        /* Clear the Pagination Table Components */
        $(FeesReceipt.Components.Table.HeadId).html("");
        $(FeesReceipt.Components.Table.BodyId).html("");
        $(FeesReceipt.Components.Table.FooterId).html("");
...
FeesReceipt.Components.Pagination.TableHead = function () {
    ...
    try {
        ...
        t_tr.appendTo(FeesReceipt.Components.Table.HeadId);
...
FeesReceipt.Components.Pagination.TableBody = function (Result) {
    ...
    try {
        ...
        for (var i = 0; i < Result.length; i++) {
            ...
            t_tr.appendTo(FeesReceipt.Components.Table.BodyId);
        }
        /* ==== */

        /* ==== */
        /* Calculate the Footer */
        FeesReceipt.Components.Pagination.TableFooter(t_TotalAmount);
        /* ==== */
    }
    catch (ex) {
...
FeesReceipt.Components.Pagination.TableFooter = function (TotalAmount) {
    ...
    try {
        ...
        t_tr.appendTo(FeesReceipt.Components.Table.FooterId);
...
FeesReceipt.Components.Pagination.DeleteRecord = function (RouteId) {
        ...
        buttons: [
            {
                ...
                click: function () {
                    ...
                    FeesReceipt.Components.Delete(RouteId);
                    $(this).dialog("close");
                }
            },
            {
