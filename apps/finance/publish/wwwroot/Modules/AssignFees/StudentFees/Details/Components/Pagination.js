    ...
    try {
        ...
        for (var i = 0; i < Result.length; i++) {
            ...
            if (Result[i].IsCancelled) {
                ...
                t_td.append('<a onclick =\"AssignStudentFeesDet.Components.Router(' + Result[i].FeesId + ',' + "'Edit'" + ')" href=\'javascript:void(0);\' title="Edit this Fees"><i class=\"ace-icon fa fa-2x fa-pencil-square-o background-gradient\" aria-hidden=\"true\"></i></a>&nbsp; ');
               ...
               // if (GeneralFunction.ReadEditRights()) t_td.append('<a onclick =\"AssignStudentFeesDet.Components.Router(' + Result[i].FeesId + ',' + "'Edit'" + ')" href=\'javascript:void(0);\' title="Edit this Fees"><i class=\"ace-icon fa fa-2x fa-pencil-square-o background-gradient\" aria-hidden=\"true\"></i></a>&nbsp; ');
               // if (GeneralFunction.ReadDeleteRights()) t_td.append('<a onclick =\"AssignStudentFeesDet.Components.Router(' + Result[i].FeesId + ',' + "'Delete'" + ')" href=\'javascript:void(0);\' title="Delete this Fees"><i class="ace-icon fa fa-2x fas fa-trash red\" aria-hidden="true"></i></a>');
            }
            t_td.appendTo(t_tr);
            /* ==== */
